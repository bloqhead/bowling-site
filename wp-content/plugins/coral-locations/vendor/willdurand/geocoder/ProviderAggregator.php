...
class ProviderAggregator implements Geocoder
{
    ...
    {
        $this->limit = $limit;
        $this->decider = $decider ? $decider : __CLASS__.'::getProvider';
    }
    ...
    public function using($name)
    {
        if (!isset($this->providers[$name])) {
            throw ProviderNotRegistered::create($name ? $name : '', $this->providers);
        }
     ...
     */
    private static function getProvider($query, $providers, Provider $currentProvider = null)
    {
