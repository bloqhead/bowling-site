...
class Address implements Location
{
    ...
    public static function createFromArray($data)
    {
        ...
        foreach ($data['adminLevels'] as $adminLevel) {
            ...
            $name = $adminLevel['name'] ? $adminLevel['name'] : $adminLevel['code'] ? $adminLevel['code'] : null;
            if (empty($name)) {
                continue;
            }

            $adminLevels[] = new AdminLevel($adminLevel['level'], $name, $adminLevel['code'] ? $adminLevel['code'] : null);
        }
